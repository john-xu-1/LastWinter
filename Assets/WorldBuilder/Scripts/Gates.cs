...
namespace WorldBuilder
{
    ...
    public class Gates
    {
        ...
        public static string enemy_rules = @"
            ...
            :- gated_door(top), tile(_,1,enemy_non_gated_door).
            :- gated_door(right), tile(max_width,_,enemy_non_gated_door).
            :- gated_door(bottom), tile(_,max_height,enemy_non_gated_door).
            :- gated_door(left), tile(1,_,enemy_non_gated_door).

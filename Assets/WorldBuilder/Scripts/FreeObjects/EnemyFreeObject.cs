    ...
    public class EnemyFreeObject : FreeObject
    {
        ...
        public static string GetEnemyRoomRules (List<string> paths)
        {
            ...
            code += $@"
                ...
                :- free_object(XX,YY,{FreeObjectTypes.enemy},_), not floor(XX,YY+1).
                :- free_object(XX,YY,{FreeObjectTypes.enemy},_), XX == max_width.
                :- free_object(XX,YY,{FreeObjectTypes.enemy},_), XX == 1.
